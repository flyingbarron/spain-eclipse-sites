/**
 * Map Handler Module - GitHub Pages Version
 * Handles Leaflet map initialization, routing, and route management
 * Modified to use gh-pages/config.js and avoid circular dependencies
 */
    ...
    setTimeout(() => {
        ...
        sites.forEach((site, index) => {
            ...
            marker.on('click', () => {
                ...
                // Trigger site details update via event
                document.dispatchEvent(new CustomEvent('siteSelected', { detail: { site } }));
            });
        });
