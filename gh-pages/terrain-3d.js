/**
 * 3D Terrain Visualization Module - GitHub Pages Version
...
export function initialize3DMap(sites) {
    if (!mapboxApiKey) {
        ...
        if (container) {
            container.innerHTML = '<div class="loading">Mapbox API key required for 3D terrain view. Please add your Mapbox API key to config.json.</div>';
        }
        return;
    }
